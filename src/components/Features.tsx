        ...
        >
          <CarouselContent className="-ml-2 md:-ml-4">
            {features.map(({ description, image }, index) => (
              <CarouselItem key={description} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
