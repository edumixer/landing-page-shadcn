...
export const TaskOrganizer = () => {
  return (
    <section id="home" className="flex flex-col h-[800px]">
      <div className="flex-1 p-8 relative overflow-hidden">
        <div className="max-w-6xl mx-auto flex items-center justify-between relative z-10">
          ...
          <div className="relative sm:w-full md:w-1/2 h-96">
            ...
            <div className="absolute top-0 right-8 sm:right-4 flex justify-center items-center z-0 lg:text-[70rem] sm:text-[10rem] text-green-500 w-[300px] h-[300px]">
              &lt;
            </div>
            ...
            <img
              ...
              className="absolute top-0 lg:left-20 sm:left-0 h-96 object-cover rounded-lg z-10"
            />
          </div>
        </div>
      </div>
